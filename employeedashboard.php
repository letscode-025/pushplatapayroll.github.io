...
<?php 
    include('dbconnection.php');
    $sql1 = "select name from employee where employeeID='$employeeIdFromUser'";
    $res1 = $con->query($sql1);
    $row1 = $res1->fetch_row();
...
<div class="container-fluid" style="background-color:black;float:left;padding:10px">
    ...
    <span class="nameandlogout" style="color:white"><?php echo "Hi, ".$name;?>&nbsp<a href="index.php" style="color:white"><i class="fa fa-sign-out" aria-hidden="true"></i></a></span>
  </div><br>
</nav>
<br><br>
<center>
