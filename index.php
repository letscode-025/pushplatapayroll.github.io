...
<nav class="" style="">
  ...
  <form action="employeedashboard.php" method="post" autocomplete="off" enctype="multipart/form-data" style="margin-top:100px">
    <div class="login-container" >
        ...
        <input type="hidden" name="one" id="" value="employee">
    </div>
  </form>
  <br>
